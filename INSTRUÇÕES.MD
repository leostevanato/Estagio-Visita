...
Clique em **Atualizar** na janela de edição do conteúdo HTML, clique em **Salvar mudanças** na edição do bloco e volte para a página principal do curso.
<br>
<br>
...
```html
<link rel="stylesheet" href="https://www.educacaoadistancia.camara.leg.br/ead_cfd/pluginfile.php/CODIGO_DA_PASTA_DE_ARQUIVOS/mod_folder/content/0/css/curso.css?forcedownload=1" />
<script src="https://www.educacaoadistancia.camara.leg.br/ead_cfd/pluginfile.php/CODIGO_DA_PASTA_DE_ARQUIVOS/mod_folder/content/0/js/curso.js?forcedownload=1" type="text/javascript"></script>
<script src="https://www.educacaoadistancia.camara.leg.br/ead_cfd/pluginfile.php/CODIGO_DA_PASTA_DE_ARQUIVOS/mod_folder/content/0/js/objetos-de-aprendizagem.js?forcedownload=1" type="text/javascript"></script>
```
Substitua a string **CODIGO_DA_PASTA_DE_ARQUIVOS** pelo código da pasta anotado no início nos três links. Clique em **Atualizar** na janela de edição do conteúdo HTML, clique em **Salvar mudanças** na edição do bloco e volte para a página principal do curso.
<br>
<br>
...
Após realizar as alterações necessárias, clique em **Atualizar** na janela de edição do conteúdo HTML, clique em **Salvar mudanças** na edição do bloco e volte para a página principal do curso.
<br>
<br>
...
### **VERFICAR O CURSO**
Verifique se todos os links, imagens e conteúdos estão corretos.
